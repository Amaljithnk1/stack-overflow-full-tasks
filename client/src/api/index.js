...
const API = axios.create({
  baseURL: "https://stack-overflow-clone-1-pmzp.onrender.com",
});
...
export const fetchPublicPosts = () => API.get("/public-posts");
export const createPublicPost = (formData) => 
  API.post('/public-posts', formData, {
    headers: {
